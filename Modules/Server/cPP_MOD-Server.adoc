...
Read and write access to the TOE’s configuration data shall be limited to Administrator, TOE and [_selection:_ [assignment: list of authorised entities], _no other entities_].
