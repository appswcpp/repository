...
The evaluator shall verify that the TSS identifies if sensitive data is transmitted by the application. It must also identify types of sensitive data transmitted.
