...
|FTP_DIT_EXT.1
|Applicable Components
|Applies to each TOE component that transmits data or sensitive data to another trusted IT product or TOE component, or invokes platform-provided functionality for that protection. Protection of inter-component TOE communications is addressed by FTP_DIT_EXT.1 in the base cPP.
|===
