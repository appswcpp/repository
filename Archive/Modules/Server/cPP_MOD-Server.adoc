...
* FTP_DIT_EXT.1 in the {base-pp} ensures that communication between trusted entities or TOE Component Instances is protected using well known protocols.
...
* configuration of communication with [_selection: other trusted IT entities outside the TOE, TOE Component Instances, other trusted IT entities outside the TOE and TOE Component Instances_]
* [_selection:_ 
